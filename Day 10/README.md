...
```text
Training Accuracy:     Add your final accuracy here
Validation Accuracy:   Add your final accuracy here
Testing Accuracy:      Add your final accuracy here
```

The project also includes a graph showing the **Training vs Validation Accuracy** during model training.

> **Note:** Replace the placeholder accuracy values with the actual results from your trained model.
...
* Understand Perceptrons, weights, and biases.
...
This project is my first step into **Deep Learning** and provides a foundation for future learning in:
