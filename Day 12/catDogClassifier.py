...
# Remove any corrupted (non-JFIF) images, which would otherwise crash training partway through on a bad file.
num_skipped = 0
...
#Build the model: MobileNetV2 backbone + custom classification head
...
#Display sample prediction images with actual vs predicted labels
